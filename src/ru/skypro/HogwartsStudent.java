...
public abstract class HogwartsStudent {
    ...
    public void compareHogwarts(HogwartsStudent hogwartsStudent) {
        ...
        if (ability1>ability2){
            System.out.printf("Студент Хогвартс %s лучше студента %s%n", getName(), hogwartsStudent.getName());
        }else if (ability2>ability1) {
            System.out.printf("Студент Хогвартс %s лучше студента %s%n", hogwartsStudent.getName(), getName());
        }else{
            System.out.printf("Студент Хогвартс %s такой же, как %s%n", hogwartsStudent.getName(), getName());
        }
    }
