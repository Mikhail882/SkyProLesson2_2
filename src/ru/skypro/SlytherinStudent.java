...
public class SlytherinStudent extends HogwartsStudent {
    ...
    public void compareSlytherin(SlytherinStudent slytherinStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("Студент Слизерин %s лучше студента %s%n", getName(), slytherinStudent.getName());
        } else if (ability2 > ability1) {
            System.out.printf("Студент Слизерин %s лучше студента %s%n", slytherinStudent.getName(), getName());
        } else {
            System.out.printf("Студент Слизерин %s такой же, как %s%n", slytherinStudent.getName(), getName());
        }
    }
